...
update member set mage=20, mbirth='2001.09.10' where mid='user5';
...
--Section04 테이블에 내용을 추가하는 INSERT 문
insert into board(bno, btitle, bcontent, bwriter)
values(5,'제목5','내용5','user2');

--Section02 테이블의 내용을 수정하는 UPDATE문
update board set bno=10 where bwriter = '임창정';

--Section03 테이블의 내용을 삭제하는 DELETE문
delete board where bno=4;
delete board where bwriter='user2';
